    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div>
                ...
                <p className="text-gray-400">Welcome back! Here's your work overview.</p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold">Payment Performance</h2>
                </div>
                ...
                <div className="space-y-4">
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xl font-bold">{paymentPercentage.toFixed(1)}%</span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pt-6 border-t border-white/10">
                        <div>
                            <p className="text-sm text-gray-400 mb-1">Submission Rate</p>
                        ...
                        <div>
                            <p className="text-sm text-gray-400 mb-1">Hours Contribution</p>
                            <p className="text-2xl font-bold">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        <h3 className="font-bold mb-2">Manage Payout</h3>
                        <p className="text-sm text-gray-400">Update your payout method and information</p>
                    </a>
                    <a
                        href="/employee/time-tracking"
                        className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors"
                    >
                        <h3 className="font-bold mb-2">Track Time</h3>
                        <p className="text-sm text-gray-400">Log your work hours on projects</p>
                    </a>
                    <a
                        href="/employee/projects"
                        className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors"
                    >
                        <h3 className="font-bold mb-2">View Projects</h3>
                        <p className="text-sm text-gray-400">Check your assigned projects</p>
                    </a>
                </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                <h2 className="text-2xl font-bold mb-2">Monitor (Demo Controls)</h2>
                <p className="text-gray-400 mb-6 text-sm">
                    Use these to simulate work activity. Admin will see the same data.
                </p>
                <div className="flex flex-wrap gap-3">
                    <button
                        className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10 transition-colors"
                        onClick={() => {
